...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-accent text-white hover:bg-cyan-600 focus:ring-cyan-500',
      secondary: 'bg-primary text-white hover:bg-slate-800 focus:ring-slate-500',
      outline: 'border-2 border-accent text-accent hover:bg-accent hover:text-white focus:ring-cyan-500',
